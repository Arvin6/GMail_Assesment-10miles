...
try:
    ...
    # Sometimes Google returns 429 Quota error due to many concurrent requests
    # Sleep for 1 second to control concurrent requests right after the requests during initialization
    time.sleep(1)
